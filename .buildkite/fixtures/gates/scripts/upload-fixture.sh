...
case "$fixture" in
  01-fanout|02-chained-approvals|03-blocked-failed|04-unblocked-failed|05-explicit-bypass|06-block-vs-input|07-group-local-gates|08-dynamic-wait|09-failure-policies|10-blocked-state-passed|10-blocked-state-running|10-blocked-state-failed|11-interwoven-gates)
    ;;
  *)
