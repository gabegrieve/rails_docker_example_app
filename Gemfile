...
# Render article bodies written in Markdown [https://github.com/vmg/redcarpet]
gem "redcarpet", "~> 3.6"
# Syntax-highlight fenced code blocks in rendered Markdown [https://github.com/rouge-ruby/rouge]
gem "rouge", "~> 4.2"
